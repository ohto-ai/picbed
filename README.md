...
- **相册管理**：
  ...
  - 单图删除在灯箱里
  - **「缩略图」开关**（工具栏最右）：列表里用 500px 长边的缩略图代替原图，首屏流量通常能降一个数量级。**需要桶已开通 COS 图片处理**（数据万象基础图片处理，≤10TB/月 免费）。两点注意：
...
| 想确认桶有没有开通图片处理 | 直接开一张图加参数：`https://<你的域名>/img/xxx.jpg?imageMogr2/thumbnail/500x`，返回缩小图即已开通 |
